        ...
        <div style="text-align: right">
            <div class="pagination">
                <ul>
                    ...
                    <li><a>第${ipage.page }页</a></li>
                    <c:if test="${ipage.page ne 1 }">
                        <li><a
                                href="<%=basePath%>admin/userList?pageNum=${ipage.page-1 }">上一页</a>
                        </li>
                    </c:if>

                    <c:if test="${ipage.page < (ipage.rows+9)/10-1 }">
                        <li><a
                                href="<%=basePath%>admin/userList?pageNum=${ipage.page+1 }">下一页</a>
                        </li>
                    </c:if>
                </ul>
            </div>
